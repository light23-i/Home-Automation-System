...
pinMode(nodeMCULight, OUTPUT);
pinMode(Fan, OUTPUT);
pinMode(Light,OUTPUT);
// Set outputs to LOW
digitalWrite(nodeMCULight, LOW);
...
Serial.println("NodeMCU LED is on");
outputNodeMCULightState = "on";
digitalWrite(nodeMCULight, HIGH);
} else if (header.indexOf("GET /2/off") >= 0) {
Serial.println("NodeMCU LED is off");
outputNodeMCULightState = "off";
digitalWrite(nodeMCULight, LOW);
...
// Display current state, and ON/OFF buttons for GPIO 2 NodeMCU LED 
client.println("<p>NodeMCU LED is " + outputNodeMCULightState + "</p>");
// If the outputNodeMCULightState is off, it displays the OFF button 
if (outputNodeMCULightState=="off") {
...
// Display current state, and ON/OFF buttons for GPIO 4 Fan
client.println("<p>Fan is " + outputLightState + "</p>");
// If the outputLightState is off, it displays the OFF button 
...
// Display current state, and ON/OFF buttons for GPIO 5 Light
client.println("<p>Light is " + outputFanState + "</p>");
// If the outputFanState is off, it displays the OFF button 
